                ...
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                            <li><a class="dropdown-item" href="index.php?action=qlsanpham&query=them">Thêm</a></li>
                            <li><a class="dropdown-item" href="index.php?action=qlsanpham&query=lietke">Danh sách sản
                                    phẩm</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
